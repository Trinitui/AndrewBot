...
const { Colors, DefaultOptions, Endpoints } = require('discord.js/src/util/Constants');
const { Error: DiscordError, RangeError, TypeError } = require('discord.js/src/errors');
...
class Util {
  ...
  static flatten(obj, ...props) {
    ...
    for (let [prop, newProp] of Object.entries(props)) {
      ...
      if (element instanceof require('discord.js/src/util/Collection')) out[newProp] = Array.from(element.keys());
      // If the valueOf is a Collection, use its array of keys
      else if (valueOf instanceof require('discord.js/src/util/Collection')) out[newProp] = Array.from(valueOf.keys());
