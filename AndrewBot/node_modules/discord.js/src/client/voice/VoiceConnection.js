...
const VoiceUDP = require('discord.js/src/client/voice/networking/VoiceUDPClient');
const VoiceWebSocket = require('discord.js/src/client/voice/networking/VoiceWebSocket');
const AudioPlayer = require('discord.js/src/client/voice/player/AudioPlayer');
const VoiceReceiver = require('discord.js/src/client/voice/receiver/Receiver');
const PlayInterface = require('discord.js/src/client/voice/util/PlayInterface');
const Silence = require('discord.js/src/client/voice/util/Silence');
const { Error } = require('discord.js/src/errors');
const { OPCodes, VoiceOPCodes, VoiceStatus, Events } = require('discord.js/src/util/Constants');
const Speaking = require('discord.js/src/util/Speaking');
