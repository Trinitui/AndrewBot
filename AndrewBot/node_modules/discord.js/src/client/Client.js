...
const ClientVoiceManager = require('discord.js/src/client/voice/ClientVoiceManager');
const WebSocketManager = require('discord.js/src/client/websocket/WebSocketManager');
const { Error, TypeError, RangeError } = require('discord.js/src/errors');
const ChannelManager = require('discord.js/src/managers/ChannelManager');
const GuildEmojiManager = require('discord.js/src/managers/GuildEmojiManager');
const GuildManager = require('discord.js/src/managers/GuildManager');
const UserManager = require('discord.js/src/managers/UserManager');
const ShardClientUtil = require('discord.js/src/sharding/ShardClientUtil');
...
const { Events, browser, DefaultOptions } = require('discord.js/src/util/Constants');
...
const Structures = require('discord.js/src/util/Structures');
