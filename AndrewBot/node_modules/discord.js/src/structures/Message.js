...
const APIMessage = require('discord.js/src/structures/APIMessage');
...
const MessageAttachment = require('discord.js/src/structures/MessageAttachment');
const Embed = require('discord.js/src/structures/MessageEmbed');
const Mentions = require('discord.js/src/structures/MessageMentions');
const ReactionCollector = require('discord.js/src/structures/ReactionCollector');
const { Error, TypeError } = require('discord.js/src/errors');
const ReactionManager = require('discord.js/src/managers/ReactionManager');
const Collection = require('discord.js/src/util/Collection');
const { MessageTypes } = require('discord.js/src/util/Constants');
const MessageFlags = require('discord.js/src/util/MessageFlags');
