...
const Base = require('discord.js/src/structures/Base');
const GuildAuditLogs = require('discord.js/src/structures/GuildAuditLogs');
const GuildPreview = require('discord.js/src/structures/GuildPreview');
const GuildTemplate = require('discord.js/src/structures/GuildTemplate');
const Integration = require('discord.js/src/structures/Integration');
const Invite = require('discord.js/src/structures/Invite');
const VoiceRegion = require('discord.js/src/structures/VoiceRegion');
const Webhook = require('discord.js/src/structures/Webhook');
const { Error, TypeError } = require('discord.js/src/errors');
const GuildChannelManager = require('discord.js/src/managers/GuildChannelManager');
const GuildEmojiManager = require('discord.js/src/managers/GuildEmojiManager');
const GuildMemberManager = require('discord.js/src/managers/GuildMemberManager');
const PresenceManager = require('discord.js/src/managers/PresenceManager');
const RoleManager = require('discord.js/src/managers/RoleManager');
const VoiceStateManager = require('discord.js/src/managers/VoiceStateManager');
...
} = require('discord.js/src/util/Constants');
const DataResolver = require('discord.js/src/util/DataResolver');
const Snowflake = require('discord.js/src/util/Snowflake');
const SystemChannelFlags = require('discord.js/src/util/SystemChannelFlags');
