...
const MessageCollector = require('discord.js/src/structures/MessageCollector');
...
const { RangeError, TypeError } = require('discord.js/src/errors');
...
// Fixes Circular
const MessageManager = require('discord.js/src/managers/MessageManager');
