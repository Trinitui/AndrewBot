...
const BaseGuildEmoji = require('discord.js/src/structures/BaseGuildEmoji');
const { Error } = require('discord.js/src/errors');
const GuildEmojiRoleManager = require('discord.js/src/managers/GuildEmojiRoleManager');
