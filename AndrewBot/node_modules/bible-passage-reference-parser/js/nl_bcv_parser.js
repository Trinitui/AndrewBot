...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:GNB96|SV(?:77)?|WV95|NB(?:G51|V)?))\b/gi;
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp("(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014]|opschrift(?![a-z])|en" + bcv_parser.prototype.regexps.space + "+volgende" + bcv_parser.prototype.regexps.space + "+verzen|zie" + bcv_parser.prototype.regexps.space + "+ook|hoofdstukken|hoofdstuk|verzen|vers|vgl|en|vs|-|v|[a-e](?!\\w)|$)+)", "gi");

  bcv_parser.prototype.regexps.match_end_split = RegExp("\\d\\W*opschrift|\\d\\W*en" + bcv_parser.prototype.regexps.space + "+volgende" + bcv_parser.prototype.regexps.space + "+verzen(?:[\\s\\xa0*]*\\.)?|\\d[\\s\\xa0*]*[a-e](?!\\w)|\\x1e(?:[\\s\\xa0*]*[)\\]\\uff09])?|[\\d\\x1f]", "gi");
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Mozes|Beresjiet|1(?:\.[\s\xa0]*Mozes|e(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|[\s\xa0]*Mozes)|I(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|G(?:en(?:esis)?|n)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Mozes|II(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|2(?:\.[\s\xa0]*Mozes|e(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|[\s\xa0]*Mozes)|Sjemot|Ex(?:od(?:us)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Bel(?:[\\s\\xa0]*en[\\s\\xa0]*de[\\s\\xa0]*draak)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Derde[\s\xa0]*Mozes|III(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|3(?:\.[\s\xa0]*Mozes|e(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|[\s\xa0]*Mozes)|[VW]ajikra|L(?:ev(?:iticus)?|v)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Vierde[\s\xa0]*Mozes|B[ae]midbar|IV(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|4(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|Nu(?:m(?:beri|eri)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Wijsheid[\\s\\xa0]*van[\\s\\xa0]*(?:J(?:ozua[\\s\\xa0]*Ben[\\s\\xa0]*Sirach|ezus[\\s\\xa0]*Sirach)|Ben[\\s\\xa0]*Sirach)|Ecclesiasticus|Jezus[\\s\\xa0]*Sirach|Sir(?:ach)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:De[\\s\\xa0]*wijsheid[\\s\\xa0]*van[\\s\\xa0]*Salomo|Het[\\s\\xa0]*boek[\\s\\xa0]*der[\\s\\xa0]*wijsheid|Wi(?:jsheid(?:[\\s\\xa0]*van[\\s\\xa0]*Salomo)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Lam|Kl(?:aagl(?:iederen)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Brief[\\s\\xa0]*van[\\s\\xa0]*Jeremia|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ap(?:ocalyps|[ck])|Rev|Op(?:enb(?:aring(?:[\\s\\xa0]*van[\\s\\xa0]*Johannes|en)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:PrMan|Man(?:asse)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:5(?:\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|V(?:ijfde[\s\xa0]*Mozes|\.[\s\xa0]*Mozes|[\s\xa0]*Mozes)|D(?:e(?:wariem|ut(?:eronomium)?)|t)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Jo(?:sh|z(?:ua)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Judg|R(?:icht(?:eren?)?|e(?:cht(?:ers)?)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(R(?:uth|t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*E(?:sdras|zra)|Derde[\s\xa0]*E(?:sdras|zra)|3(?:\.[\s\xa0]*E(?:sdras|zra)|e(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|[\s\xa0]*E(?:sdras|zra))|I(?:II(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|1(?:\.[\s\xa0]*E(?:sdras|zra)|e(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|[\s\xa0]*E(?:sdras|zra)|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*E(?:sdras|zra)|Vierde[\s\xa0]*E(?:sdras|zra)|I(?:[IV](?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra)))|4(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|2(?:\.[\s\xa0]*E(?:sdras|zra)|e(?:\.[\s\xa0]*E(?:sdras|zra)|[\s\xa0]*E(?:sdras|zra))|[\s\xa0]*E(?:sdras|zra)|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Isa|J(?:es(?:aja)?|s)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Sam(?:u[eë]l)?|Samuel[\s\xa0]*II|II(?:\.[\s\xa0]*Sam(?:u[eë]l)?|[\s\xa0]*Sam(?:u[eë]l)?)|2(?:\.[\s\xa0]*Sam(?:u[eë]l)?|e(?:\.[\s\xa0]*Sam(?:u[eë]l)?|[\s\xa0]*Sam(?:u[eë]l)?)|Sam|[\s\xa0]*S(?:am(?:u[eë]l)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Sam(?:u[eë]l)?|Samuel[\s\xa0]*I|I(?:\.[\s\xa0]*Sam(?:u[eë]l)?|[\s\xa0]*Sam(?:u[eë]l)?)|1(?:\.[\s\xa0]*Sam(?:u[eë]l)?|e(?:\.[\s\xa0]*Sam(?:u[eë]l)?|[\s\xa0]*Sam(?:u[eë]l)?)|Sam|[\s\xa0]*S(?:am(?:u[eë]l)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Ko(?:n(?:ingen)?)?|II(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|[\s\xa0]*Ko(?:n(?:ingen)?)?)|2(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|e(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|[\s\xa0]*Ko(?:n(?:ingen)?)?)|[\s\xa0]*Ko(?:n(?:ingen)?)?|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Ko(?:n(?:ingen)?)?|1(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|e(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|[\s\xa0]*Ko(?:n(?:ingen)?)?)|[\s\xa0]*Ko(?:n(?:ingen)?)?|Kgs)|I(?:\.[\s\xa0]*Ko(?:n(?:ingen)?)?|[\s\xa0]*Ko(?:n(?:ingen)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Kron(?:ieken)?|II(?:\.[\s\xa0]*Kron(?:ieken)?|[\s\xa0]*Kron(?:ieken)?)|2(?:\.[\s\xa0]*Kron(?:ieken)?|e(?:\.[\s\xa0]*Kron(?:ieken)?|[\s\xa0]*Kron(?:ieken)?)|[\s\xa0]*Kr(?:on(?:ieken)?)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Kron(?:ieken)?|I(?:\.[\s\xa0]*Kron(?:ieken)?|[\s\xa0]*Kron(?:ieken)?)|1(?:\.[\s\xa0]*Kron(?:ieken)?|e(?:\.[\s\xa0]*Kron(?:ieken)?|[\s\xa0]*Kron(?:ieken)?)|[\s\xa0]*Kr(?:on(?:ieken)?)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        ...
        osis: ["GkEsth"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Est(?:er[\\s\\xa0]*\\(Gr(?:ieks\\)|\\.\\)|\\))|[\\s\\xa0]*gr)|GkEsth))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Esth"],
        ...
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Gebed[\\s\\xa0]*van[\\s\\xa0]*Azarja|PrAzar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Prov|Spr(?:euken)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[KQ]oheleth?|Eccl|Pr(?:ed(?:iker)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Gezang[\\s\\xa0]*der[\\s\\xa0]*drie[\\s\\xa0]*mannen[\\s\\xa0]*in[\\s\\xa0]*het[\\s\\xa0]*vuur|Lied[\\s\\xa0]*van[\\s\\xa0]*de[\\s\\xa0]*drie[\\s\\xa0]*jongemannen|SgThree))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Canticum[\\s\\xa0]*canticorum|Song|H(?:oogl(?:ied)?|l)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:er(?:emia)?|r))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Eze(?:ch(?:i[eë]l)?|k))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Da(?:n(?:i[eë]l)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Hos(?:ea)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:o[eë]l|l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Amos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Am(?:os)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ob(?:ad(?:ja)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Jon(?:ah?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Mi(?:c(?:ha|a)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sef(?:anja)?|Ze(?:ph|f(?:anja)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Hag(?:g(?:a[iï])?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Z(?:ach(?:aria)?|ech))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Mal(?:eachi)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Matth[eé](?:[uü]s)|(?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Matte[uü]s|M(?:at(?:t(?:e[uü]s|h)?)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Mar[ck]us|M(?:ar(?:[ck](?:us)?)|[ck])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Lu[ck]as|L(?:u(?:c(?:as)?|k(?:as|e)?)|[ck])))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(1John|(?:Eerste[\s\xa0]*Joh(?:annes)?|1(?:\.[\s\xa0]*Joh(?:annes)?|e(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)|[\s\xa0]*Joh(?:annes)?)|I(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(2John|(?:Tweede[\s\xa0]*Joh(?:annes)?|II(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)|2(?:\.[\s\xa0]*Joh(?:annes)?|e(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)|[\s\xa0]*Joh(?:annes)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(3John|(?:Derde[\s\xa0]*Joh(?:annes)?|III(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)|3(?:\.[\s\xa0]*Joh(?:annes)?|e(?:\.[\s\xa0]*Joh(?:annes)?|[\s\xa0]*Joh(?:annes)?)|[\s\xa0]*Joh(?:annes)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Evangelie[\\s\\xa0]*volgens[\\s\\xa0]*Johannes|Joh(?:annes|n)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Acts|H(?:and(?:elingen(?:[\\s\\xa0]*(?:van[\\s\\xa0]*de[\\s\\xa0]*apostelen|der[\\s\\xa0]*apostelen))?)?|nd)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Rom(?:einen(?:brief)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|II(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?))|2(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|e(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?))|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|I(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?))|1(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|e(?:\.[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?))|[\s\xa0]*(?:Corint(?:i[eë]rs?|h(?:i[eë]rs?|e))|Kor(?:int(?:i[eë]rs?|h(?:i[eë]rs?|e)))?)|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Gal(?:aten(?:brief)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(E(?:ph|f(?:ez(?:i[eë]rs)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Phil|Fil(?:ip(?:penzen)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:[CK]ol(?:ossenzen)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|II(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))|2(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|Thess|e(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|1(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|Thess|e(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))|I(?:\.[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?)|[\s\xa0]*T(?:hess(?:alonicenzen)?|es(?:s(?:alonicenzen)?)?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|II(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?)|2(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|e(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?)|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|I(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?)|1(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|e(?:\.[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?)|[\s\xa0]*Tim(?:ot(?:he[uü]s|e[uü]s))?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Tit(?:us)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Fil(?:émon|em(?:on)?|m)|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Heb(?:r(?:ee[eë]n)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ja(?:k(?:obus)?|s))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Pet(?:r(?:us)?)?|II(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pet(?:r(?:us)?)?)|2(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|e(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pet(?:r(?:us)?)?)|[\s\xa0]*Pe(?:t(?:r(?:us)?)?)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Pet(?:r(?:us)?)?|I(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pet(?:r(?:us)?)?)|1(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|e(?:\.[\s\xa0]*Pet(?:r(?:us)?)?|[\s\xa0]*Pet(?:r(?:us)?)?)|[\s\xa0]*Pe(?:t(?:r(?:us)?)?)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        ...
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Tob(?:i(?:as?|t)|ías?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        ...
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tweede[\s\xa0]*Mak(?:kabee[eë]n)?|II(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|2(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|e(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|[\s\xa0]*Mak(?:kabee[eë]n)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Derde[\s\xa0]*Mak(?:kabee[eë]n)?|III(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|3(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|e(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|[\s\xa0]*Mak(?:kabee[eë]n)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Vierde[\s\xa0]*Mak(?:kabee[eë]n)?|IV(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|4(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Eerste[\s\xa0]*Mak(?:kabee[eë]n)?|1(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|e(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)|[\s\xa0]*Mak(?:kabee[eë]n)?|Macc)|I(?:\.[\s\xa0]*Mak(?:kabee[eë]n)?|[\s\xa0]*Mak(?:kabee[eë]n)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezek", "Ezra"],
...
var grammar = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c40 = "en",
        peg$c41 = { type: "literal", value: "en", description: "\"en\"" },
        peg$c42 = "volgende",
        peg$c43 = { type: "literal", value: "volgende", description: "\"volgende\"" },
        peg$c44 = "verzen",
        peg$c45 = { type: "literal", value: "verzen", description: "\"verzen\"" },
        peg$c46 = /^[a-z]/,
        ...
        peg$c49 = "opschrift",
        peg$c50 = { type: "literal", value: "opschrift", description: "\"opschrift\"" },
        ...
        peg$c66 = "hoofdstuk",
        peg$c67 = { type: "literal", value: "hoofdstuk", description: "\"hoofdstuk\"" },
        peg$c68 = "ken",
        peg$c69 = { type: "literal", value: "ken", description: "\"ken\"" },
        peg$c70 = "",
        peg$c71 = function() { return {"type": "c_explicit"} },
        peg$c72 = "v",
        peg$c73 = { type: "literal", value: "v", description: "\"v\"" },
        peg$c74 = "erzen",
        peg$c75 = { type: "literal", value: "erzen", description: "\"erzen\"" },
        peg$c76 = "ers",
        peg$c77 = { type: "literal", value: "ers", description: "\"ers\"" },
        peg$c78 = "s",
        ...
        peg$c87 = "vgl",
        peg$c88 = { type: "literal", value: "vgl", description: "\"vgl\"" },
        peg$c89 = "zie",
        peg$c90 = { type: "literal", value: "zie", description: "\"zie\"" },
        peg$c91 = "ook",
        peg$c92 = { type: "literal", value: "ook", description: "\"ook\"" },
        ...
        peg$c97 = "from",
        peg$c98 = { type: "literal", value: "from", description: "\"from\"" },
        peg$c99 = "of",
        ...
        peg$c105 = "book",
        peg$c106 = { type: "literal", value: "book", description: "\"book\"" },
        peg$c107 = /^[([]/,
        ...
        peg$c122 = /^[\s\xa0*]/,
        peg$c123 = { type: "class", value: "[\\s\\xa0\\*]", description: "[\\s\\xa0\\*]" },
