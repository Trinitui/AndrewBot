    ...
    books = [
      {
        ...
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ̀-ʹͶ-ͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-Ͽ᷀-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼ⃐-⃿Ⱡ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:δυτικ[οό]ς[\s\xa0]*Χρονικ(?:[ωώ]ν[\s\xa0]*Β['ʹʹ΄’])|Παραλειπομ[έε]νων[\s\xa0]*Β['ʹʹ΄’]|Β(?:['ʹʹ΄’][\s\xa0]*(?:Παρ?|Χρ(?:ον(?:ικ[ωώ]ν)?)?))|2Chr)|Χρονικ(?:[ωώ]ν[\s\xa0]*Β['΄ʹʹ’]))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏ̀-ʹͶ-ͷͺ-ͽΆΈ-ΊΌΎ-ΡΣ-ϵϷ-Ͽ᷀-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼ⃐-⃿Ⱡ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:δυτικ[οό]ς[\s\xa0]*Χρονικ(?:[ωώ]ν[\s\xa0]*Α['ʹʹ΄’])|Παραλειπομ[έε]νων[\s\xa0]*Α['ʹʹ΄’]|Α(?:['ʹʹ΄’][\s\xa0]*(?:Παρ?|Χρ(?:ον(?:ικ[ωώ]ν)?)?))|1Chr)|Χρονικ(?:[ώω]ν[\s\xa0]*Α[ʹʹ΄’']))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
...
var grammar = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c40 = "\u03BA\u03B1\u03B9",
        peg$c41 = { type: "literal", value: "\u03BA\u03B1\u03B9", description: "\"\\u03BA\\u03B1\\u03B9\"" },
        peg$c42 = "\u03BC\u03B5\u03C4",
        peg$c43 = { type: "literal", value: "\u03BC\u03B5\u03C4", description: "\"\\u03BC\\u03B5\\u03C4\"" },
        peg$c44 = /^[\u03AC\u03B1]/i,
        peg$c45 = { type: "class", value: "[\u03AC\u03B1]i", description: "[\u03AC\u03B1]i" },
        peg$c46 = /^[a-z]/,
        ...
        peg$c49 = "\u03BF",
        peg$c50 = { type: "literal", value: "\u03BF", description: "\"\\u03BF\"" },
        peg$c51 = "\u03C4",
        peg$c52 = { type: "literal", value: "\u03C4", description: "\"\\u03C4\"" },
        peg$c53 = /^[\u03AF\u03B9]/i,
        peg$c54 = { type: "class", value: "[\u03AF\u03B9]i", description: "[\u03AF\u03B9]i" },
        peg$c55 = "\u03C4\u03BB\u03BF\u03C2",
        peg$c56 = { type: "literal", value: "\u03C4\u03BB\u03BF\u03C2", description: "\"\\u03C4\\u03BB\\u03BF\\u03C2\"" },
        peg$c57 = "\u03C4\u03BB\u03BF\u03C3",
        peg$c58 = { type: "literal", value: "\u03C4\u03BB\u03BF\u03C3", description: "\"\\u03C4\\u03BB\\u03BF\\u03C3\"" },
        ...
        peg$c71 = /^[\u03B1-\u03B5]/i,
        peg$c72 = { type: "class", value: "[\u03B1-\u03B5]i", description: "[\u03B1-\u03B5]i" },
        peg$c73 = function(val) { return {"type": "v", "value": [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c74 = "\u03BA\u03B5\u03C6",
        peg$c75 = { type: "literal", value: "\u03BA\u03B5\u03C6", description: "\"\\u03BA\\u03B5\\u03C6\"" },
        peg$c76 = "\u03BB\u03B1\u03B9\u03B1",
        peg$c77 = { type: "literal", value: "\u03BB\u03B1\u03B9\u03B1", description: "\"\\u03BB\\u03B1\\u03B9\\u03B1\"" },
        peg$c78 = "\u03BB\u03B1\u03B9\u03BF\u03BD",
        peg$c79 = { type: "literal", value: "\u03BB\u03B1\u03B9\u03BF\u03BD", description: "\"\\u03BB\\u03B1\\u03B9\\u03BF\\u03BD\"" },
        peg$c80 = "\u03BB\u03B1\u03B9\u03BF",
        peg$c81 = { type: "literal", value: "\u03BB\u03B1\u03B9\u03BF", description: "\"\\u03BB\\u03B1\\u03B9\\u03BF\"" },
        peg$c82 = function() { return {"type": "c_explicit"} },
        peg$c83 = "\u03C3\u03C4",
        peg$c84 = { type: "literal", value: "\u03C3\u03C4", description: "\"\\u03C3\\u03C4\"" },
        peg$c85 = "\u03C7\u03BF",
        peg$c86 = { type: "literal", value: "\u03C7\u03BF", description: "\"\\u03C7\\u03BF\"" },
        peg$c87 = "\u03C2",
        peg$c88 = { type: "literal", value: "\u03C2", description: "\"\\u03C2\"" },
        peg$c89 = "\u03B9",
        peg$c90 = { type: "literal", value: "\u03B9", description: "\"\\u03B9\"" },
        peg$c91 = "\u03C3",
        peg$c92 = { type: "literal", value: "\u03C3", description: "\"\\u03C3\"" },
        ...
        peg$c103 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c104 = "from",
        ...
        peg$c118 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c119 = "\x1E",
        peg$c120 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c121 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c122 = ",000",
        peg$c123 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c124 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c125 = /^[^\x1F\x1E([]/,
        peg$c126 = { type: "class", value: "[^\\x1f\\x1e\\(\\[]", description: "[^\\x1f\\x1e\\(\\[]" },
        peg$c127 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c128 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c129 = /^[\s\xa0*]/,
