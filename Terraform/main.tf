...
module "elastic_beanstalk_application" {
    source      = "github.com/cloudposse/terraform-aws-elastic-beanstalk-application?ref=v0.7.1"
    namespace   = "AndrewBot"
    stage       = "prod"
    name        = "AndrewBotapp"
...
module "elastic_beanstalk_environment" {
    source                             = "github.com/cloudposse/terraform-aws-elastic-beanstalk-environment?ref=v0.31.0"
    namespace                          = "AndrewBot"
    stage                              = "prod"
    name                               = "app"
