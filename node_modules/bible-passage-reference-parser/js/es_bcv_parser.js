    ...
    books = [
      {
        ...
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ec(?:lesi[aá]stico|clus)|Si(?:r(?:[aá]c(?:id(?:es|a))?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Wis|S(?:ab(?:idur[ií]a)?|b)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        ...
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:u(?:dg|e(?:c(?:es)?)?)|c))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ec(?:cles(?:s[ai](?:[ai]t(?:[eé]s?))|a[ai]t(?:[eé]s?))|les(?:s[ai](?:[ai]t(?:[eé]s?))|a[ai]t(?:[eé]s?)))|(?:Ec(?:c(?:l(?:es(?:s[ai](?:[ai]st(?:[eé]s?))|a[ai]st(?:[eé]s?)|i(?:a(?:st(?:i(?:c[eé]s|[eé]s)|[eé]s?)|t[eé]s?)|i(?:st[eé]s?|t[eé]s?)))?)?)?|l(?:es(?:s[ai](?:[ai]st(?:[eé]s?))|a[ai]st(?:[eé]s?)|i(?:a(?:st(?:i(?:c[eé]s|[eé]s)|[eé]s?)|t[eé]s?)|i(?:st[eé]s?|t[eé]s?)))?)?)?|Qo))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:El[\s\xa0]*(?:Canto[\s\xa0]*de[\s\xa0]*los[\s\xa0]*(?:Tres[\s\xa0]*J(?:[oó]venes[\s\xa0]*(?:Hebreos|Jud[ií]os))|3[\s\xa0]*J(?:[oó]venes[\s\xa0]*(?:Hebreos|Jud[ií]os)))|Himno[\s\xa0]*de[\s\xa0]*los[\s\xa0]*(?:Tres[\s\xa0]*J(?:[oó]venes[\s\xa0]*(?:Hebreos|Jud[ií]os))|3[\s\xa0]*J(?:[oó]venes[\s\xa0]*(?:Hebreos|Jud[ií]os))))|Ct[\s\xa0]*3[\s\xa0]*J[oó]|SgThree)|(?:Canto[\s\xa0]*de[\s\xa0]*los[\s\xa0]*(?:Tres[\s\xa0]*J(?:[óo]venes(?:[\s\xa0]*(?:Hebreos|Jud[ií]os))?)|3[\s\xa0]*J(?:[oó]venes(?:[\s\xa0]*(?:Hebreos|Jud[íi]os))?))|Himno[\s\xa0]*de[\s\xa0]*los[\s\xa0]*(?:Tres[\s\xa0]*J[oó]venes(?:[\s\xa0]*Jud(?:[íi]os)?)|3[\s\xa0]*J(?:[óo]venes(?:[\s\xa0]*(?:Hebreos|Jud[ií]os))?))|Tres[\s\xa0]*J[oó]venes|3[\s\xa0]*J[óo]venes)|Himno[\s\xa0]*de[\s\xa0]*los[\s\xa0]*Tres[\s\xa0]*J(?:[oó]venes))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Song"],
        ...
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:er(?:e(?:m[ií]as?)?)?|r))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Zeph|S(?:f|o(?:f(?:on[ií]as)?)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ag(?:eo)?|H(?:ag(?:geo|eo)?|g)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Z(?:ech|a(?:c(?:ar(?:[ií]as)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(M(?:al(?:a(?:qu(?:[ií]as)?)?)?|l))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        ...
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Phil|F(?:il(?:i(?:p(?:enses)?)?)?|lp)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        ...
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(T(?:i(?:t(?:us|o)?)?|t))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        ...
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(T(?:ob(?:it?|t)?|b))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        ...
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ba(?:r(?:uc)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sus"],
        apocrypha: true,
...
var grammar = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c40 = "y",
        peg$c41 = { type: "literal", value: "y", description: "\"y\"" },
        peg$c42 = "siguientes",
        peg$c43 = { type: "literal", value: "siguientes", description: "\"siguientes\"" },
        peg$c44 = "sig",
        peg$c45 = { type: "literal", value: "sig", description: "\"sig\"" },
        peg$c46 = /^[a-z]/,
        ...
        peg$c49 = "subt",
        peg$c50 = { type: "literal", value: "subt", description: "\"subt\"" },
        peg$c51 = /^[\xEDi]/i,
        peg$c52 = { type: "class", value: "[\xEDi]i", description: "[\xEDi]i" },
        peg$c53 = "tulo",
        peg$c54 = { type: "literal", value: "tulo", description: "\"tulo\"" },
        peg$c55 = "t",
        peg$c56 = { type: "literal", value: "t", description: "\"t\"" },
        peg$c57 = "t\xEDt",
        peg$c58 = { type: "literal", value: "t\xEDt", description: "\"t\\xEDt\"" },
        peg$c59 = function(val_1) { return {"type": "integer_title", "value": [val_1], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c60 = "/9\x1F",
        peg$c61 = { type: "literal", value: "/9\x1F", description: "\"/9\\x1F\"" },
        peg$c62 = function(val) { return {"type": "context", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c63 = "/2\x1F",
        peg$c64 = { type: "literal", value: "/2\x1F", description: "\"/2\\x1F\"" },
        peg$c65 = ".1",
        peg$c66 = { type: "literal", value: ".1", description: "\".1\"" },
        peg$c67 = /^[0-9]/,
        peg$c68 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c69 = function(val) { return {"type": "bc", "value": [val, {"type": "c", "value": [{"type": "integer", "value": 151, "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [peg$currPos - 2, peg$currPos - 1]}], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c70 = function(val_1, val_2) { return {"type": "bcv", "value": [val_1, {"type": "v", "value": [val_2], "indices": [val_2.indices[0], val_2.indices[1]]}], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c71 = /^[a-e]/,
        peg$c72 = { type: "class", value: "[a-e]", description: "[a-e]" },
        peg$c73 = function(val) { return {"type": "v", "value": [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c74 = "cap",
        peg$c75 = { type: "literal", value: "cap", description: "\"cap\"" },
        peg$c76 = "tulos",
        peg$c77 = { type: "literal", value: "tulos", description: "\"tulos\"" },
        peg$c78 = "s",
        peg$c79 = { type: "literal", value: "s", description: "\"s\"" },
        peg$c80 = function() { return {"type": "c_explicit"} },
        peg$c81 = "v",
        peg$c82 = { type: "literal", value: "v", description: "\"v\"" },
        peg$c83 = "ers",
        peg$c84 = { type: "literal", value: "ers", description: "\"ers\"" },
        peg$c85 = "culos",
        peg$c86 = { type: "literal", value: "culos", description: "\"culos\"" },
        peg$c87 = "culo",
        peg$c88 = { type: "literal", value: "culo", description: "\"culo\"" },
        peg$c89 = "er",
        peg$c90 = { type: "literal", value: "er", description: "\"er\"" },
        peg$c91 = "ss",
        peg$c92 = { type: "literal", value: "ss", description: "\"ss\"" },
        peg$c93 = function() { return {"type": "v_explicit"} },
        peg$c94 = ":",
        ...
        peg$c103 = "\xE1",
        peg$c104 = { type: "literal", value: "\xE1", description: "\"\\xE1\"" },
        peg$c105 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c106 = "from",
        peg$c107 = { type: "literal", value: "from", description: "\"from\"" },
        peg$c108 = "of",
        peg$c109 = { type: "literal", value: "of", description: "\"of\"" },
        peg$c110 = "in",
        peg$c111 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c112 = "the",
        peg$c113 = { type: "literal", value: "the", description: "\"the\"" },
        peg$c114 = "book",
        peg$c115 = { type: "literal", value: "book", description: "\"book\"" },
        peg$c116 = /^[([]/,
        peg$c117 = { type: "class", value: "[\\(\\[]", description: "[\\(\\[]" },
        peg$c118 = /^[)\]]/,
        peg$c119 = { type: "class", value: "[\\)\\]]", description: "[\\)\\]]" },
        peg$c120 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c121 = "\x1E",
        peg$c122 = { type: "literal", value: "\x1E", description: "\"\\x1E\"" },
        peg$c123 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c124 = ",000",
        peg$c125 = { type: "literal", value: ",000", description: "\",000\"" },
        peg$c126 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c127 = /^[^\x1F\x1E([]/,
        peg$c128 = { type: "class", value: "[^\\x1f\\x1e\\(\\[]", description: "[^\\x1f\\x1e\\(\\[]" },
        peg$c129 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c130 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c131 = /^[\s\xa0*]/,
        peg$c132 = { type: "class", value: "[\\s\\xa0\\*]", description: "[\\s\\xa0\\*]" },
