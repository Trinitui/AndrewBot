...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:CKK)\b/gi;
  ...
  bcv_parser.prototype.regexps.first = "(?:Prva|1|I)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.second = "(?:Druga|2|II)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.third = "(?:Treæa|Tre[ćc]a|3|III)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.range_and = "(?:[&\u2013\u2014-]|i|-)";
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Postanka|Post(?:anak)?|Gen))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Exod"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Izlaska|E(?:gzodus|xod)|Izl(?:azak)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bel"],
        apocrypha: true,
        ...
        osis: ["Lev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Lev(?:itski[\\s\\xa0]*zakonik)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Num"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Brojeva|Num|Br(?:ojevi)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Sirahova|Sir))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Mudrosti|Mudr|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jeremijine[\\s\\xa0]*tu[zž]aljke|Lam(?:entacije)?|Tu(?:[zž](?:aljke)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Pismo[\\s\\xa0]*Jeremije[\\s\\xa0]*proroka|Jeremijino[\\s\\xa0]*pismo|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Apokalipsa|Otk(?:rivenje(?:[\\s\\xa0]*Ivanovo)?)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Deut|P(?:onovljeni[\\s\\xa0]*zakon|nz)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:o(?:šua|s(?:ua|h))|[sš]))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*o[\\s\\xa0]*Sucima|Judg|Suci))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*o[\\s\\xa0]*Ruti|Rut[ah]?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1Esd"],
        apocrypha: true,
        ...
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(I(?:sa|z(?:aija)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*(?:knjiga[\s\xa0]*o[\s\xa0]*Samuelu|Samuelova(?:[\s\xa0]*knjiga)?)|II(?:\.[\s\xa0]*Samuelova|[\s\xa0]*Samuelova)|2(?:\.[\s\xa0]*Samuelova|[\s\xa0]*Sam(?:uelova)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*(?:knjiga[\s\xa0]*o[\s\xa0]*Samuelu|Samuelova(?:[\s\xa0]*knjiga)?)|I(?:\.[\s\xa0]*Samuelova|[\s\xa0]*Samuelova)|1(?:\.[\s\xa0]*Samuelova|[\s\xa0]*Sam(?:uelova)?|Sam)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*(?:knjiga[\s\xa0]*o[\s\xa0]*Kraljevima|Kraljevima)|II(?:\.[\s\xa0]*Kraljevima|[\s\xa0]*Kraljevima)|2(?:\.[\s\xa0]*Kraljevima|[\s\xa0]*Kr(?:aljevima)?|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*(?:knjiga[\s\xa0]*o[\s\xa0]*Kraljevima|Kraljevima)|I(?:\.[\s\xa0]*Kraljevima|[\s\xa0]*Kraljevima)|1(?:\.[\s\xa0]*Kraljevima|[\s\xa0]*Kr(?:aljevima)?|Kgs)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*(?:knjiga[\s\xa0]*Ljetopisa|Ljetopisa)|II(?:\.[\s\xa0]*Ljetopisa|[\s\xa0]*Ljetopisa)|2(?:\.[\s\xa0]*Ljetopisa|[\s\xa0]*Ljet(?:opisa)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*(?:knjiga[\s\xa0]*Ljetopisa|Ljetopisa)|I(?:\.[\s\xa0]*Ljetopisa|[\s\xa0]*Ljetopisa)|1(?:\.[\s\xa0]*Ljetopisa|[\s\xa0]*Ljet(?:opisa)?|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Ezrina|Ezra?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Neh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*Nehemijina|Neh(?:emija)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["GkEsth"],
        apocrypha: true,
        ...
        osis: ["Esth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Est(?:era|h)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Job"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Knjiga[\\s\\xa0]*o[\\s\\xa0]*Jobu|Job))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ps"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ps(?:al(?:am|m[ei]))?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrAzar"],
        apocrypha: true,
        ...
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Mudre[\\s\\xa0]*izreke|P(?:oslovice|rov)|Izr))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Kohelet|Eccl|Prop(?:ovjednik)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        ...
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Song|Pj(?:esma[\\s\\xa0]*nad[\\s\\xa0]*pjesmama)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:er(?:emija)?|r))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ez(?:ek(?:iel)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(D(?:an(?:iel)?|n))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ho(?:[sš](?:ea)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        ...
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ob(?:ad(?:ija)?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Jon(?:ah?)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Mi(?:c|h(?:ej)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        ...
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Zeph|S(?:ofonije|ef(?:anija)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Agej|Hag(?:[ae]j)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Z(?:ech|ah(?:arija)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Mal(?:ahija)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jevanđelje[\\s\\xa0]*po[\\s\\xa0]*Mateju|Evan[ðđ]elje[\\s\\xa0]*po[\\s\\xa0]*Mateju|M(?:at(?:ej|t)|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jevanđelje[\\s\\xa0]*po[\\s\\xa0]*Marku|Evan[ðđ]elje[\\s\\xa0]*po[\\s\\xa0]*Marku|M(?:arko?|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Jevanđelje[\\s\\xa0]*po[\\s\\xa0]*Luki|Evan[ðđ]elje[\\s\\xa0]*po[\\s\\xa0]*Luki|L(?:uk[ae]|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*Ivanova(?:[\s\xa0]*[Pp]oslanica)?|I(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?)|1(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|John|[\s\xa0]*Iv(?:anova(?:[\s\xa0]*Poslanica)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*Ivanova(?:[\s\xa0]*[Pp]oslanica)?|II(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?)|2(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|John|[\s\xa0]*Iv(?:anova(?:[\s\xa0]*Poslanica)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(Tre[cæć]a[\s\xa0]*Ivanova[\s\xa0]*(?:[Pp]oslanica)|(?:Tre[cæć]a[\s\xa0]*Ivanova|III(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?)|3(?:\.[\s\xa0]*Ivanova(?:[\s\xa0]*Poslanica)?|John|[\s\xa0]*Iv(?:anova(?:[\s\xa0]*Poslanica)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Evan[ðđ]elje[\\s\\xa0]*po[\\s\\xa0]*Ivanu|J(?:evanđelje[\\s\\xa0]*po[\\s\\xa0]*Ivanu|ohn)|Iv(?:an)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Acts|Dj(?:ela[\\s\\xa0]*apostolska)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Rimljanima|oslanica[\\s\\xa0]*Rimljanima)|R(?:im(?:ljanima)?|om)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlova[\s\xa0]*druga[\s\xa0]*poslanica[\s\xa0]*Korin[cć]anima|Druga[\s\xa0]*(?:Korin[cć]anima[\s\xa0]*Poslanica|poslanica[\s\xa0]*Korinæanima)|II(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica)|2(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Kor(?:in[cć]anima[\s\xa0]*Poslanica)?|Cor))|(?:Druga[\s\xa0]*(?:poslanica[\s\xa0]*Korin[ćc]anima|Korin[ćc]anima)|II(?:\.[\s\xa0]*Korin[ćc]anima|[\s\xa0]*Korin[cć]anima)|2(?:\.[\s\xa0]*Korin[cć]anima|[\s\xa0]*Korin[cć]anima)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:P(?:avlova[\s\xa0]*prva[\s\xa0]*poslanica[\s\xa0]*Korin[cć]anima|rva[\s\xa0]*(?:Korin[cć]anima[\s\xa0]*Poslanica|poslanica[\s\xa0]*Korinæanima))|I(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica)|1(?:\.[\s\xa0]*Korin[cć]anima[\s\xa0]*Poslanica|[\s\xa0]*Kor(?:in[cć]anima[\s\xa0]*Poslanica)?|Cor))|(?:Prva[\s\xa0]*(?:poslanica[\s\xa0]*Korin[ćc]anima|Korin[cć]anima)|[I1](?:\.[\s\xa0]*Korin(?:[ćc]anima|[\s\xa0]*Korin[cć]anima)))|[I1][\s\xa0]*Korin(?:[cć]anima))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Gala[cć]anima|oslanica[\\s\\xa0]*Gala[cæć]anima)|Gal(?:a[cć]anima)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Efe[zž]anima|oslanica[\\s\\xa0]*Efe[zž]anima)|E(?:ph|f(?:e[zž]anima)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Filipljanima|oslanica[\\s\\xa0]*Filipljanima|hil)|Fil(?:ipljanima)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Kolo[sš]anima|oslanica[\\s\\xa0]*Kolo[sš]anima)|Col|Kol(?:o[sš]anima)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlova[\s\xa0]*druga[\s\xa0]*poslanica[\s\xa0]*Solunjanima|Druga[\s\xa0]*(?:poslanica[\s\xa0]*Solunjanima|Solunjanima(?:[\s\xa0]*Poslanica)?)|II(?:\.[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?)|2(?:\.[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?|Thess|[\s\xa0]*Sol(?:unjanima(?:[\s\xa0]*Poslanica)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:P(?:avlova[\s\xa0]*prva[\s\xa0]*poslanica[\s\xa0]*Solunjanima|rva[\s\xa0]*(?:poslanica[\s\xa0]*Solunjanima|Solunjanima(?:[\s\xa0]*Poslanica)?))|I(?:\.[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?)|1(?:\.[\s\xa0]*Solunjanima(?:[\s\xa0]*Poslanica)?|Thess|[\s\xa0]*Sol(?:unjanima(?:[\s\xa0]*Poslanica)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Pavlova[\s\xa0]*druga[\s\xa0]*poslanica[\s\xa0]*Timoteju|Druga[\s\xa0]*(?:poslanica[\s\xa0]*Timoteju|Timoteju(?:[\s\xa0]*Poslanica)?)|II(?:\.[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?)|2(?:\.[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Tim(?:oteju(?:[\s\xa0]*Poslanica)?)?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:P(?:avlova[\s\xa0]*prva[\s\xa0]*poslanica[\s\xa0]*Timoteju|rva[\s\xa0]*(?:poslanica[\s\xa0]*Timoteju|Timoteju(?:[\s\xa0]*Poslanica)?))|I(?:\.[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?)|1(?:\.[\s\xa0]*Timoteju(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Tim(?:oteju(?:[\s\xa0]*Poslanica)?)?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Titu|oslanica[\\s\\xa0]*Titu)|Tit(?:us?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Filemonu|oslanica[\\s\\xa0]*Filemonu|hlm)|F(?:ilemonu|lm)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:P(?:avlova[\\s\\xa0]*poslanica[\\s\\xa0]*Hebrejima|oslanica[\\s\\xa0]*Hebrejima)|Heb(?:rejima)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ja(?:k(?:ovljeva(?:[\\s\\xa0]*poslanica)?)?|s))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*Petrova(?:[\s\xa0]*[Pp]oslanica)?|II(?:\.[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?)|2(?:\.[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*P(?:etrova(?:[\s\xa0]*Poslanica)?|t)|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*Petrova(?:[\s\xa0]*[Pp]oslanica)?|I(?:\.[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?)|1(?:\.[\s\xa0]*Petrova(?:[\s\xa0]*Poslanica)?|[\s\xa0]*P(?:etrova(?:[\s\xa0]*Poslanica)?|t)|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Poslanica[\\s\\xa0]*Jude[\\s\\xa0]*apostola|J(?:ud(?:ina(?:[\\s\\xa0]*poslanica)?|e)|d)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Tob(?:ija)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(J(?:udita|dt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Bar(?:uh)?)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Su(?:s|z(?:ana)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Druga[\s\xa0]*knjiga[\s\xa0]*o[\s\xa0]*Makabejcima|2(?:[\s\xa0]*Mak|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Tre[cć]a[\s\xa0]*knjiga[\s\xa0]*o[\s\xa0]*Makabejcima|3(?:[\s\xa0]*Mak|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])(4(?:[\s\xa0]*Mak|Macc))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Prva[\s\xa0]*knjiga[\s\xa0]*o[\s\xa0]*Makabejcima|1(?:[\s\xa0]*Mak|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }
    ];
...
var grammar = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c62 = "poglavlja",
        peg$c63 = { type: "literal", value: "poglavlja", description: "\"poglavlja\"" },
        peg$c64 = "poglavlje",
        peg$c65 = { type: "literal", value: "poglavlje", description: "\"poglavlje\"" },
        peg$c66 = "glava",
        peg$c67 = { type: "literal", value: "glava", description: "\"glava\"" },
        ...
        peg$c78 = "i",
        peg$c79 = { type: "literal", value: "i", description: "\"i\"" },
