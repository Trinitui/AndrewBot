...
(function() {
  ...
  bcv_parser.prototype.regexps.translations = /(?:(?:ERV|BPB))\b/gi;
  ...
  bcv_parser.prototype.regexps.first = "(?:Първа|1|I)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.second = "(?:Втора|2|II)\\.?" + bcv_parser.prototype.regexps.space + "*";

  bcv_parser.prototype.regexps.third = "(?:Трето|3|III)\\.?" + bcv_parser.prototype.regexps.space + "*";
    ...
    books = [
      {
        ...
        osis: ["Gen"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първа[\s\xa0]*(?:книга[\s\xa0]*Моисеева|Моисеева)|(?:[1I](?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева))|Gen|Бит(?:ие)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Exod"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втора[\s\xa0]*(?:книга[\s\xa0]*Моисеева|Моисеева)|II(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|2(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|Exod|Изх(?:од)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Bel|Бел))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lev"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Трет(?:а[\s\xa0]*книга[\s\xa0]*Моисеева|о[\s\xa0]*Моисеева)|III(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|3(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|Lev|Лев(?:ит)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Num"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:IV(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|4(?:\.[\s\xa0]*Моисеева|[\s\xa0]*Моисеева)|Num|Ч(?:етвърта[\s\xa0]*(?:книга[\s\xa0]*Моисеева|Моисеева)|ис(?:ла)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Sir"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Премъдрост[\\s\\xa0]*на[\\s\\xa0]*Иисус,[\\s\\xa0]*син[\\s\\xa0]*Сирахов|Книга[\\s\\xa0]*(?:Премъдрост[\\s\\xa0]*на[\\s\\xa0]*Иисуса,[\\s\\xa0]*син[\\s\\xa0]*Сирахов|на[\\s\\xa0]*Сирах)|Сирахов|Sir))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Wis"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*(?:Премъдрост[\\s\\xa0]*Соломонова|на[\\s\\xa0]*мъдростта)|Премъдрост(?:[\\s\\xa0]*Соломонова)?|Wis))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Lam"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Плач[\\s\\xa0]*Иеремиев|П(?:\\.[\\s\\xa0]*[ИЙ]ер|[\\s\\xa0]*[ИЙ]ер|лач(?:ът[\\s\\xa0]*на[\\s\\xa0]*(?:[ИЙ]еремия|Еремия)|[\\s\\xa0]*(?:Иеремиев|Еремиев))?)|Lam))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["EpJer"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*на[\\s\\xa0]*Иеремия|EpJer))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rev"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Апокалипсис|Откр(?:овение(?:то[\\s\\xa0]*на[\\s\\xa0]*[ИЙ]оан|[\\s\\xa0]*на[\\s\\xa0]*(?:св(?:\\.[\\s\\xa0]*Иоана[\\s\\xa0]*Богослова|[\\s\\xa0]*Иоана[\\s\\xa0]*Богослова)|[ИЙ]оан))?)?|Rev))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrMan"],
        apocrypha: true,
        ...
        osis: ["Deut"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Пета[\s\xa0]*книга[\s\xa0]*Моисеева|5[\s\xa0]*Моисеева|Deut|Вт(?:орозак(?:оние)?)?))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Josh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*(?:на[\\s\\xa0]*Исус[\\s\\xa0]*Навиев|Иисус[\\s\\xa0]*Навин)|Josh|И(?:исус[\\s\\xa0]*Навин|с(?:ус[\\s\\xa0]*Нави(?:ев|н)|\\.[\\s\\xa0]*Нав|[\\s\\xa0]*Нав)|\\.[\\s\\xa0]*Н|[\\s\\xa0]*Н)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Judg"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*(?:Съдии[\\s\\xa0]*Израилеви|на[\\s\\xa0]*съдиите)|Judg|Съд(?:ии(?:[\\s\\xa0]*Израилеви)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ruth"],
        ...
        osis: ["1Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първа[\s\xa0]*(?:книга[\s\xa0]*на[\s\xa0]*Ездра|Ездра)|I(?:\.[\s\xa0]*Ездра|[\s\xa0]*Ездра)|1(?:\.[\s\xa0]*Ездра|[\s\xa0]*Ездра|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Esd"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втора[\s\xa0]*(?:книга[\s\xa0]*на[\s\xa0]*Ездра|Ездра)|II(?:\.[\s\xa0]*Ездра|[\s\xa0]*Ездра)|2(?:\.[\s\xa0]*Ездра|[\s\xa0]*Ездра|Esd)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Isa"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Исаия|Isa|Ис(?:а(?:ия|я))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втора[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|книга[\s\xa0]*(?:на[\s\xa0]*Самуил|Царства)|Самуил|Цар(?:ства|е))|II(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е)))|2(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е))|Sam|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Ц(?:ар(?:ства|е))?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Sam"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първа[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|книга[\s\xa0]*(?:на[\s\xa0]*Самуил|Царства)|Самуил|Цар(?:ства|е))|I(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е)))|1(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Цар(?:ства|е))|Sam|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Самуил|Ц(?:ар(?:ства|е))?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Четвърта[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|книга[\s\xa0]*(?:на[\s\xa0]*царете|Царства)|Цар(?:ства|е))|IV(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е)))|2Kgs|4(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Ц(?:ар(?:ства|е))?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Kgs"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Трет(?:а[\s\xa0]*книга[\s\xa0]*(?:на[\s\xa0]*царете|Царства)|о[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е)))|III(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е)))|1Kgs|3(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Цар(?:ства|е))|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*царете|Ц(?:ар(?:ства|е))?))))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:или[\s\xa0]*Втора[\s\xa0]*книга[\s\xa0]*Паралипоменон|Втора[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|книга[\s\xa0]*(?:Паралипоменон|на[\s\xa0]*летописите)|Лет(?:описи)?)|II(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?))|2(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Chr"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:или[\s\xa0]*Първа[\s\xa0]*книга[\s\xa0]*Паралипоменон|Първа[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|книга[\s\xa0]*(?:Паралипоменон|на[\s\xa0]*летописите)|Лет(?:описи)?)|I(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?))|1(?:\.[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|[\s\xa0]*(?:Книга[\s\xa0]*на[\s\xa0]*летописите|Лет(?:описи)?)|Chr)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*Ездра|Ezra|Езд(?:ра)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Neh"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*Неемия|Неем(?:ия)?|Neh))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["GkEsth"],
        apocrypha: true,
        ...
        osis: ["Esth"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Естир|Esth|Ест(?:ир)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Job"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*(?:Иова?|Йов)|Job|[ИЙ]ов))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ps"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Ps|Пс(?:ал(?:тир|ми|ом))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["PrAzar"],
        apocrypha: true,
        ...
        osis: ["Prov"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Притчи[\\s\\xa0]*Соломонови|Prov|Пр(?:итчи(?:[\\s\\xa0]*Соломонови)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eccl"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*Еклисиаста[\\s\\xa0]*или[\\s\\xa0]*Проповедника|Проповедника|Eccl|Екл(?:есиаст|исиаста?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["SgThree"],
        apocrypha: true,
        ...
        osis: ["Song"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*Песен[\\s\\xa0]*на[\\s\\xa0]*Песните,[\\s\\xa0]*от[\\s\\xa0]*Соломона|Song|П(?:\\.[\\s\\xa0]*П|[\\s\\xa0]*П|ес(?:ен[\\s\\xa0]*на[\\s\\xa0]*песните)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jer"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*(?:[ИЙ]еремия|Еремия)|Jer|(?:[ИЙ]ер(?:емия)?)|Ер(?:емия)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Ezek"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*(?:Иезекииля|Езекиил)|Ezek|Езек(?:и(?:ил|л))?|Иез(?:екииля?)?|Йез(?:екиил)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Dan"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Даниила?|Dan|Дан(?:аил|иила?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Осия|Hos|Ос(?:ия)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Joel"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Иоиля?|Joel|Иоиля?|Йоил))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Amos"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Амоса?|Amos|Ам(?:оса?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Авди[ий]|Obad|Авд(?:и[ий])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jonah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Иона|Jonah|[ИЙ]она?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mic"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Михе[ий]|Mic|Мих(?:е[ий])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Nah"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Наума?|Наума?|Nah))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hab"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Авакума?|Hab|Ав(?:ак(?:ума?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zeph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Софония|Zeph|Соф(?:они[ийя])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hag"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Аге[ий]|Hag|Аг(?:е[ий])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Zech"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Захария|Zech|Зах(?:ария)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*пророк[\\s\\xa0]*Малахия|Mal|Мал(?:ахия)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Matt"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Евангелие[\\s\\xa0]*от[\\s\\xa0]*Мате[ий]|От[\\s\\xa0]*Матея(?:[\\s\\xa0]*свето[\\s\\xa0]*Евангелие)?|Matt|Мат(?:е[ий])?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Mark"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Евангелие[\\s\\xa0]*от[\\s\\xa0]*Марко|От[\\s\\xa0]*Марка(?:[\\s\\xa0]*свето[\\s\\xa0]*Евангелие)?|Mark|Марко?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Luke"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Евангелие[\\s\\xa0]*от[\\s\\xa0]*Лука|От[\\s\\xa0]*Лука(?:[\\s\\xa0]*свето[\\s\\xa0]*Евангелие)?|Luke|Лука))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["1John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първ(?:о[\s\xa0]*(?:съборно[\s\xa0]*послание[\s\xa0]*на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова)|[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова))|послание[\s\xa0]*на[\s\xa0]*[ИЙ]оан)|а[\s\xa0]*(?:[ИЙ]оан(?:ово)?))|I(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?))|1(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втор(?:о[\s\xa0]*(?:съборно[\s\xa0]*послание[\s\xa0]*на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова)|[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова))|послание[\s\xa0]*на[\s\xa0]*[ИЙ]оан)|а[\s\xa0]*(?:[ИЙ]оан(?:ово)?))|II(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?))|2(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3John"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Трето[\s\xa0]*(?:съборно[\s\xa0]*послание[\s\xa0]*на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова)|[\s\xa0]*ап(?:\.[\s\xa0]*Иоана[\s\xa0]*Богослова|[\s\xa0]*Иоана[\s\xa0]*Богослова))|послание[\s\xa0]*на[\s\xa0]*[ИЙ]оан|(?:[ИЙ]оан(?:ово)?))|III(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?))|3(?:\.[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|[\s\xa0]*(?:[ИЙ]оан(?:ово)?)|John)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["John"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Евангелие[\\s\\xa0]*от[\\s\\xa0]*[ИЙ]оан|От[\\s\\xa0]*Иоана(?:[\\s\\xa0]*свето[\\s\\xa0]*Евангелие)?|John|[ИЙ]оан))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Acts"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Апостол|Acts|Д(?:\\.[\\s\\xa0]*А|е(?:ла|ян(?:ия(?:та[\\s\\xa0]*на[\\s\\xa0]*апостолите|[\\s\\xa0]*на[\\s\\xa0]*(?:светите[\\s\\xa0]*Апостоли|апостолите))?)?)|[\\s\\xa0]*А)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Rom"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Римляни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Римляни)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Римляни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Римляни))|към[\\s\\xa0]*римляните)|римляните|Rom|Рим(?:л(?:яни)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втор(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни))|към[\s\xa0]*коринтяните)|а[\s\xa0]*Кор(?:интяни(?:те)?)?)|II(?:\.[\s\xa0]*Кор(?:интяни(?:те)?)?|[\s\xa0]*Кор(?:интяни(?:те)?)?)|2(?:\.[\s\xa0]*Кор(?:интяни(?:те)?)?|[\s\xa0]*Кор(?:интяни(?:те)?)?|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Cor"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първ(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Коринтяни))|към[\s\xa0]*коринтяните)|а[\s\xa0]*Кор(?:интяни(?:те)?)?)|I(?:\.[\s\xa0]*Кор(?:интяни(?:те)?)?|[\s\xa0]*Кор(?:интяни(?:те)?)?)|1(?:\.[\s\xa0]*Кор(?:интяни(?:те)?)?|[\s\xa0]*Кор(?:интяни(?:те)?)?|Cor)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Gal"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Галатяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Галатяни)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Галатяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Галатяни))|към[\\s\\xa0]*галатяните)|Gal|Гал(?:атяни(?:те)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Eph"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Ефесяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Ефесяни)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Ефесяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Ефесяни))|към[\\s\\xa0]*ефесяните)|Eph|Еф(?:есяни(?:те)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phil"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филипяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филипяни)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филипяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филипяни))|към[\\s\\xa0]*филипяните)|Phil|Фил(?:ипяни(?:те)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Col"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Колосяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Колосяни)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Колосяни|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Колосяни))|към[\\s\\xa0]*колосяните)|Col|Кол(?:осяни(?:те)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втор(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни))|към[\s\xa0]*солунците)|а[\s\xa0]*Сол(?:унци(?:те)?)?)|II(?:\.[\s\xa0]*Сол(?:унци(?:те)?)?|[\s\xa0]*Сол(?:унци(?:те)?)?)|2(?:\.[\s\xa0]*Сол(?:унци(?:те)?)?|Thess|[\s\xa0]*Сол(?:унци(?:те)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Thess"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първ(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Солуняни))|към[\s\xa0]*солунците)|а[\s\xa0]*Сол(?:унци(?:те)?)?)|1(?:\.[\s\xa0]*Сол(?:унци(?:те)?)?|Thess|[\s\xa0]*Сол(?:унци(?:те)?)?)|I(?:\.[\s\xa0]*Сол(?:унци(?:те)?)?|[\s\xa0]*Сол(?:унци(?:те)?)?)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["2Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втор(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея))|към[\s\xa0]*Тимоте[ий])|а[\s\xa0]*Тим(?:оте[ий])?)|II(?:\.[\s\xa0]*Тим(?:оте[ий])?|[\s\xa0]*Тим(?:оте[ий])?)|2(?:\.[\s\xa0]*Тим(?:оте[ий])?|[\s\xa0]*Тим(?:оте[ий])?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Tim"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първ(?:о[\s\xa0]*послание[\s\xa0]*(?:на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея)|[\s\xa0]*ап(?:\.[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея|[\s\xa0]*Павла[\s\xa0]*до[\s\xa0]*Тимотея))|към[\s\xa0]*Тимоте[ий])|а[\s\xa0]*Тим(?:оте[ий])?)|I(?:\.[\s\xa0]*Тим(?:оте[ий])?|[\s\xa0]*Тим(?:оте[ий])?)|1(?:\.[\s\xa0]*Тим(?:оте[ий])?|[\s\xa0]*Тим(?:оте[ий])?|Tim)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Titus"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Тита|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Тита)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Тита|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Тита))|към[\\s\\xa0]*Тит)|Titus|Тит))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Phlm"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филимона|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филимона)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филимона|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Филимона))|към[\\s\\xa0]*Филимон)|Филим(?:он)?|Phlm))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Heb"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Послание[\\s\\xa0]*(?:на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Евреите|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Евреите)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Евреите|[\\s\\xa0]*Павла[\\s\\xa0]*до[\\s\\xa0]*Евреите))|към[\\s\\xa0]*евреите)|Heb|Евр(?:еи(?:те)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jas"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Съборно[\\s\\xa0]*послание[\\s\\xa0]*на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Иакова|[\\s\\xa0]*Иакова)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Иакова|[\\s\\xa0]*Иакова))|Послание[\\s\\xa0]*на[\\s\\xa0]*Яков|Jas|Як(?:ов)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втор(?:о[\s\xa0]*(?:съборно[\s\xa0]*послание[\s\xa0]*на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Петра|[\s\xa0]*Петра)|[\s\xa0]*ап(?:\.[\s\xa0]*Петра|[\s\xa0]*Петра))|послание[\s\xa0]*на[\s\xa0]*Петър)|а[\s\xa0]*Пет(?:ър|р(?:ово)?)?)|II(?:\.[\s\xa0]*Пет(?:ър|р(?:ово)?)?|[\s\xa0]*Пет(?:ър|р(?:ово)?)?)|2(?:\.[\s\xa0]*Пет(?:ър|р(?:ово)?)?|[\s\xa0]*Пет(?:ър|р(?:ово)?)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Pet"],
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първ(?:о[\s\xa0]*(?:съборно[\s\xa0]*послание[\s\xa0]*на[\s\xa0]*св(?:\.[\s\xa0]*ап(?:\.[\s\xa0]*Петра|[\s\xa0]*Петра)|[\s\xa0]*ап(?:\.[\s\xa0]*Петра|[\s\xa0]*Петра))|послание[\s\xa0]*на[\s\xa0]*Петър)|а[\s\xa0]*Пет(?:ър|р(?:ово)?)?)|I(?:\.[\s\xa0]*Пет(?:ър|р(?:ово)?)?|[\s\xa0]*Пет(?:ър|р(?:ово)?)?)|1(?:\.[\s\xa0]*Пет(?:ър|р(?:ово)?)?|[\s\xa0]*Пет(?:ър|р(?:ово)?)?|Pet)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Jude"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Съборно[\\s\\xa0]*послание[\\s\\xa0]*на[\\s\\xa0]*св(?:\\.[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Иуда|[\\s\\xa0]*Иуда)|[\\s\\xa0]*ап(?:\\.[\\s\\xa0]*Иуда|[\\s\\xa0]*Иуда))|Послание[\\s\\xa0]*на[\\s\\xa0]*Юда|Jude|Юда))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Tob"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*(?:за[\\s\\xa0]*Тобия|на[\\s\\xa0]*Товита?)|То(?:бия|вита?)|Tob))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Jdt"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*(?:за[\\s\\xa0]*Юдита|Иудит)|Иудит|Jdt))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Bar"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Книга[\\s\\xa0]*на[\\s\\xa0]*(?:пророк[\\s\\xa0]*Варуха|Барух)|Варуха?|Bar))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Sus"],
        apocrypha: true,
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")((?:Sus|Сус))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["2Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Втора[\s\xa0]*(?:книга[\s\xa0]*(?:на[\s\xa0]*Макавеите|Макаве[ий]ска)|Макавеи)|II(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи)|2(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["3Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Трет(?:а[\s\xa0]*книга[\s\xa0]*Макаве[ий]ска|о[\s\xa0]*(?:книга[\s\xa0]*на[\s\xa0]*Макавеите|Макавеи))|III(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи)|3(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["4Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Четвърта[\s\xa0]*(?:книга[\s\xa0]*на[\s\xa0]*Макавеите|Макавеи)|IV(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи)|4(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["1Macc"],
        apocrypha: true,
        regexp: /(^|[^0-9A-Za-zªµºÀ-ÖØ-öø-ɏЀ-ҁ҃-҇Ҋ-ԧḀ-ỿⱠ-Ɀⷠ-ⷿꙀ-꙯ꙴ-꙽ꙿ-ꚗꚟꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:Първа[\s\xa0]*(?:книга[\s\xa0]*(?:на[\s\xa0]*Макавеите|Макаве[ий]ска)|Макавеи)|I(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи)|1(?:\.[\s\xa0]*Макавеи|[\s\xa0]*Макавеи|Macc)))(?:(?=[\d\s\xa0.:,;\x1e\x1f&\(\)（）\[\]\/"'\*=~\-\u2013\u2014])|$)/gi
      }, {
        osis: ["Ezek", "Ezra"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ез)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }, {
        osis: ["Hab", "Obad"],
        regexp: RegExp("(^|" + bcv_parser.prototype.regexps.pre_book + ")(Ав)(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)（）\\[\\]/\"'\\*=~\\-\\u2013\\u2014])|$)", "gi")
      }
    ];
...
var grammar = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c40 = "\u0438",
        peg$c41 = { type: "literal", value: "\u0438", description: "\"\\u0438\"" },
        peg$c42 = "\u0441\u043B",
        peg$c43 = { type: "literal", value: "\u0441\u043B", description: "\"\\u0441\\u043B\"" },
        peg$c44 = /^[a-z]/,
        ...
        peg$c47 = "title",
        peg$c48 = { type: "literal", value: "title", description: "\"title\"" },
        peg$c49 = function(val_1) { return {"type": "integer_title", "value": [val_1], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c50 = "/9\x1F",
        peg$c51 = { type: "literal", value: "/9\x1F", description: "\"/9\\x1F\"" },
        peg$c52 = function(val) { return {"type": "context", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c53 = "/2\x1F",
        peg$c54 = { type: "literal", value: "/2\x1F", description: "\"/2\\x1F\"" },
        peg$c55 = ".1",
        ...
        peg$c61 = /^[a\u0430\u0431]/i,
        peg$c62 = { type: "class", value: "[a\u0430\u0431]i", description: "[a\u0430\u0431]i" },
        peg$c63 = function(val) { return {"type": "v", "value": [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c64 = "\u0433\u043B",
        peg$c65 = { type: "literal", value: "\u0433\u043B", description: "\"\\u0433\\u043B\"" },
        peg$c66 = "\u0430\u0432\u0430",
        peg$c67 = { type: "literal", value: "\u0430\u0432\u0430", description: "\"\\u0430\\u0432\\u0430\"" },
        peg$c68 = "\u0430\u0432\u0438",
        peg$c69 = { type: "literal", value: "\u0430\u0432\u0438", description: "\"\\u0430\\u0432\\u0438\"" },
        peg$c70 = "",
        peg$c71 = function() { return {"type": "c_explicit"} },
        peg$c72 = "verse",
        peg$c73 = { type: "literal", value: "verse", description: "\"verse\"" },
        peg$c74 = function() { return {"type": "v_explicit"} },
        peg$c75 = ":",
        ...
        peg$c85 = "from",
        peg$c86 = { type: "literal", value: "from", description: "\"from\"" },
        peg$c87 = "of",
        peg$c88 = { type: "literal", value: "of", description: "\"of\"" },
        peg$c89 = "in",
        peg$c90 = { type: "literal", value: "in", description: "\"in\"" },
        peg$c91 = "the",
        peg$c92 = { type: "literal", value: "the", description: "\"the\"" },
        peg$c93 = "book",
        peg$c94 = { type: "literal", value: "book", description: "\"book\"" },
        peg$c95 = /^[([]/,
        ...
        peg$c110 = /^[\s\xa0*]/,
        peg$c111 = { type: "class", value: "[\\s\\xa0\\*]", description: "[\\s\\xa0\\*]" },
